...
export default function History({ route, navigation }) {
  ...
  const LoadInsight = async () => {
    ...
    try 
    {
      ...
      */
      ...
      formData.append('tLogMain', tToken);
  ...
  return (
    <View style={styles.container}>
      <ImageBackground resizeMode="cover" style={styles.imageBg}>
        ...
        >
          <Appbar.Action icon={require("../assets/icons/chart2.png")} onPress={() => navigation.navigate("Insight", { tToken: tToken })} size={35} color={AppConfig.whiteColor} />
          <Appbar.Action icon={require("../assets/icons/home2.png")} onPress={() => navigation.navigate("Home", { tToken: tToken })} size={35} color={AppConfig.whiteColor} />
          <Appbar.Action icon={require("../assets/icons/box3.png")} onPress={() => navigation.navigate("Menu", { tToken: tToken })} size={35} color={AppConfig.whiteColor} />
        </Appbar>
